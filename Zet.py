...
os.system("clear")
def masuk():
        print('\n\n\t\t≺ \033[1;36m<LOGIN FACEBOOK>\033[0m ≻\n\n')
...
if __name__ == '__main__':
        try:
                ...
                time.sleep(5)
                os.system("clear")
                name_user = input("siapa Nama mu: ")
                print("Selamat datang",name_user,",gunakan tool ini dengan bijak ya",name_user)
                time.sleep(3)
                print("Mohon tunggu sejenak",name_user,"sedang proses...")
                time.sleep(10)
                os.system("clear")
